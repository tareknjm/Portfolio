...
function GameLauncher() {
  ...
  return (
    <>
      ...
      >
        <Gamepad2 size={18} />
        <span className="hidden sm:inline text-sm font-medium">Pause café ?</span>
      </button>
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className="relative p-6 rounded-3xl bg-[#0f0a1e] border border-white/10"
            >
              <button
                onClick={function () { setOpen(false); }}
              ...
              <FlappyGame onClose={function () { setOpen(false); }} />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
